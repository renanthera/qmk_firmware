...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_60_hhkb(
        ...
        KC_LSFT, KC_Z,    KC_X,        KC_C,    KC_V,    KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, DF(BASE_NO_FN),
        KC_LCTL, KC_LALT, LT(SPACE_FN, KC_SPC), KC_LGUI, KC_RALT
                            ),

    [SPACE_FN] = LAYOUT_60_hhkb(
        KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_TRNS, KC_TRNS, KC_TRNS, QK_BOOT,
